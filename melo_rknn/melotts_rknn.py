import numpy as np
# soundfile only needed for CLI __main__; keep optional for Docker image size
try:
    import soundfile
...
def get_args():
    ...
    parser.add_argument("--decoder", "-d", type=str, required=False, default="decoder_rk3566.rknn")
